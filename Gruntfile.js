...
var client = algoliasearch("9HOA31XFL6", process.env.ALGOLIAKEY);
...
module.exports = function(grunt) {
    ...
    var processMDFile = function(abspath, filename) {
        ...
        var pageIndex;
            ...
            parsecontent = content[1].trim();
            var frontMatter;
            try {
                frontMatter = toml.parse(parsecontent.trim());
            } catch (e) {
            ...
            pageIndex = {
                ...
                thumbnail: "https://archive.org/services/img/" + frontMatter.archiveid,
